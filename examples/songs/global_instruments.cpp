...
void initGlobalInstruments() {
    ...
    GLOBAL_INSTRUMENTS_BANK[SNARE].setData(C0deTracker::WHITENOISE, C0deTracker::ADSR(100000.f, 9.66f, 0.05f, 1.f), 1.f, 0.0f, 0.0025f, 0.0f);
    ...
    GLOBAL_INSTRUMENTS_BANK[CRASH].setData(C0deTracker::WHITENOISE, C0deTracker::ADSR(10000.f, 1.86f, 0.00f, 5.f), 1.f, 0.f,0.0055f,0.f);
    GLOBAL_INSTRUMENTS_BANK[WOOD].setData(C0deTracker::WHITENOISE2, C0deTracker::ADSR(10000.f, 50.75f, 0.0f, 0.f), 1.f, 0.0f, 0.1f, 0.0f);
    ...
    GLOBAL_INSTRUMENTS_BANK[SQUARE_WAVE].setData(C0deTracker::SQUARE, C0deTracker::ADSR(10000000, 0, 1.f, 100), 1.0f, 0.0, 1.f, 0.f);
    GLOBAL_INSTRUMENTS_BANK[WHITENOISETEST].setData(C0deTracker::WHITENOISE2, C0deTracker::ADSR(500.f, 0.f, 1.f, 500.f), 0.28f, -C0deTracker::Notes::PITCHES_PER_OCTAVE*4, 0.1f, 0.0f);
    ...
    GLOBAL_INSTRUMENTS_BANK[TRANS_FX0].setData(C0deTracker::WHITENOISE, C0deTracker::ADSR(0.2f, .2f, 0.00f, 0.f), 1.f, 0.f,0.0055f,0.f);
    GLOBAL_INSTRUMENTS_BANK[GAME_OVER_FX0].setData(C0deTracker::SQUARE, C0deTracker::ADSR(10.f, 2.5f, 0.f, 0.5f), 1.f, 0.0f, .5f, 0.f);
    ...
    GLOBAL_INSTRUMENTS_BANK[TOM].setData(C0deTracker::WHITENOISE, C0deTracker::ADSR(10000.f, 7.f, 0.05f, 5.f), .5f, .0f, .6f, 0.0f);
