...
Sonic_GreenHillZoneTheme::Sonic_GreenHillZoneTheme() : Track_Data(
...
#define UI32 uint_fast32_t
    ...
    SETINSTRDAT(HITHAT,C0deTracker::WHITENOISE, C0deTracker::ADSR(50.f, 18.f, 0.0f, 0.f), .55f, .0f, .00077f, .0f);
    SETINSTRDAT(SNARE, C0deTracker::WHITENOISE, C0deTracker::ADSR(100000.f, 13.f, 0.1f, 4.f), 1.f, .0f, .0025f, .0f);
    SETINSTRDAT(KICK, C0deTracker::WHITENOISE, C0deTracker::ADSR(10000.f, 50.75f, 0.0f, 0.f), .66f, .0f, .1f, .0f);
    SETINSTRDAT(SQUARE, C0deTracker::SQUARE, C0deTracker::ADSR(100.0f, 0.f, 0.0f, 100.f), .1f, .0f, .5f, .0f);
    SETINSTRDAT(BELL, C0deTracker::SINUS, C0deTracker::ADSR(500.0f, 5.f, 0.05f, 500.f), .56f, .0f, 1.0f, .0f);
    SETINSTRDAT(LEAD, C0deTracker::SINUS, C0deTracker::ADSR(5.f, .7f, .0f, 5.f), .17f, .0f, .085f, .0f);
    SETINSTRDAT(ACCOMP, C0deTracker::SAW, C0deTracker::ADSR(100.f, .65f, .0f, 5.f), .1f, .0f, .696969f, .0f);
    SETINSTRDAT(BASS, C0deTracker::WHITENOISE, C0deTracker::ADSR(100.f, 1.33f, .0f, 10.f), .14f, .0f, .5f, .9f);
    ...
    P(SN3, 0x02, 0x01); P(SN3, 0x03, 0x01); P(SN3, 0x04, 0x01); P(SN3, 0x05, 0x01); P(SN3, 0x06, 0x01); P(SN3, 0x07, 0x01);
    P(SN3, 0x08, 0x01); P(SN3, 0x09, 0x01); P(SN3, 0x0A, 0x01); P(SN3, 0x0B, 0x01); P(SN3, 0x0C, 0x01); P(SN3, 0x0D, 0x01);
    P(SN3, 0x0E, 0x01); P(SN3, 0x0F, 0x01); P(SN3, 0x10, 0x01); P(SN3, 0x11, 0x01); P(SN3, 0x12, 0x01); P(SN3, 0x13, 0x01);
    P(SN3, 0x14, 0x01); P(SN3, 0x15, 0x01); P(SN3, 0x16, 0x01); P(SN3, 0x17, 0x01); P(SN3, 0x18, 0x01); P(SN3, 0x19, 0x01);
    P(SN3, 0x1A, 0x01); P(SN3, 0x1B, 0x01); P(SN3, 0x1C, 0x01); P(SN3, 0x1D, 0x01); P(SN3, 0x1E, 0x01); P(SN3, 0x1F, 0x01);
    P(SN3, 0x20, 0x01);
    ...
    P(SN1, 0x02, 0x01); P(SN1, 0x03, 0x01); P(SN1, 0x04, 0x01); P(SN1, 0x04, 0x01);
    P(SN1, 0x05, 0x01); P(SN1, 0x06, 0x01); P(SN1, 0x07, 0x01); P(SN1, 0x08, 0x01);
    ...
    P(SN1, 0x09, 0x02); P(SN1, 0x0A, 0x03); P(SN1, 0x0B, 0x02); P(SN1, 0x0C, 0x03); P(SN1, 0x0D, 0x02); P(SN1, 0x0E, 0x03);
    P(SN1, 0x0F, 0x04); P(SN1, 0x10, 0x05); P(SN1, 0x11, 0x02); P(SN1, 0x12, 0x03); P(SN1, 0x13, 0x02); P(SN1, 0x14, 0x03);
    P(SN1, 0x15, 0x02); P(SN1, 0x16, 0x03); P(SN1, 0x17, 0x04); P(SN1, 0x18, 0x05); P(SN1, 0x19, 0x06); P(SN1, 0x1A, 0x07);
    P(SN1, 0x1B, 0x08); P(SN1, 0x1C, 0x09); P(SN1, 0x1D, 0x0A); P(SN1, 0x1E, 0x0B); P(SN1, 0x1F, 0x0C); P(SN1, 0x20, 0x0D);
    ...
    P(SN0, 9, 7); P(SN0, 0x0A, 8); P(SN0, 0x0B, 7);
    P(SN0, 0x0C, 8); P(SN0, 0x0D, 7); P(SN0, 0x0E, 8);
    ...
    P(SN0, 0x0F, 0x09); P(SN0, 0x10, 0x0A); P(SN0, 0x11, 0x07); P(SN0, 0x12, 0x08); P(SN0, 0x13, 0x07);
    P(SN0, 0x14, 0x08); P(SN0, 0x15, 0x07); P(SN0, 0x16, 0x08); P(SN0, 0x17, 0x09); P(SN0, 0x18, 0x0A);
    ...
    P(SN0, 0x19, 0x0B); P(SN0, 0x1A, 0x0C); P(SN0, 0x1B, 0x0D); P(SN0, 0x1C, 0x0E);
    P(SN0, 0x1D, 0x0F); P(SN0, 0x1E, 0x10); P(SN0, 0x1F, 0x11); P(SN0, 0x20, 0x12);
    ...
    P(FM5, 0x02, 0x01); P(FM5, 0x03, 0x01); P(FM5, 0x04, 0x01);
    P(FM5, 0x05, 0x01); P(FM5, 0x06, 0x01); P(FM5, 0x07, 0x01);
    ...
    P(FM2, 0x06, 0x05); P(FM2, 0x07, 0x06); P(FM2, 0x08, 0x04); P(FM2, 0x09, 0x04); P(FM2, 0x0A, 0x07); P(FM2, 0x0B, 0x04);
    P(FM2, 0x0C, 0x08); P(FM2, 0x0D, 0x04); P(FM2, 0x0E, 0x07); P(FM2, 0x0F, 0x04); P(FM2, 0x10, 0x09); P(FM2, 0x11, 0x0A);
    P(FM2, 0x12, 0x0B); P(FM2, 0x13, 0x0A); P(FM2, 0x14, 0x0C); P(FM2, 0x15, 0x0A); P(FM2, 0x16, 0x0B); P(FM2, 0x17, 0x0D);
    P(FM2, 0x18, 0x0E); P(FM2, 0x19, 0x0F); P(FM2, 0x1A, 0x10); P(FM2, 0x1B, 0x11); P(FM2, 0x1C, 0x12); P(FM2, 0x1D, 0x13);
    P(FM2, 0x1E, 0x14); P(FM2, 0x1F, 0x15); P(FM2, 0x20, 0x16);
    ...
    P(FM3, 0x04, 0x00); P(FM3, 0x05, 0x04); P(FM3, 0x06, 0x04); P(FM3, 0x07, 0x05); P(FM3, 0x08, 0x00); P(FM3, 0x09, 0x06);
    P(FM3, 0x0A, 0x07); P(FM3, 0x0B, 0x06); P(FM3, 0x0C, 0x07); P(FM3, 0x0D, 0x06); P(FM3, 0x0E, 0x08); P(FM3, 0x0F, 0x09);
    P(FM3, 0x10, 0x0A); P(FM3, 0x11, 0x0B); P(FM3, 0x12, 0x0C); P(FM3, 0x13, 0x0B); P(FM3, 0x14, 0x0D); P(FM3, 0x15, 0x0B);
    P(FM3, 0x16, 0x0C); P(FM3, 0x17, 0x0B); P(FM3, 0x18, 0x0B); P(FM3, 0x19, 0x0E); P(FM3, 0x1A, 0x0E); P(FM3, 0x1B, 0x0F);
    P(FM3, 0x1C, 0x0F); P(FM3, 0x1D, 0x10); P(FM3, 0x1E, 0x10); P(FM3, 0x1F, 0x11); P(FM3, 0x20, 0x11);
    ...
    P(FM4, 0x04, 0x00); P(FM4, 0x05, 0x04); P(FM4, 0x06, 0x04); P(FM4, 0x07, 0x05); P(FM4, 0x08, 0x00); P(FM4, 0x09, 0x06);
    P(FM4, 0x0A, 0x07); P(FM4, 0x0B, 0x06); P(FM4, 0x0C, 0x07); P(FM4, 0x0D, 0x06); P(FM4, 0x0E, 0x08); P(FM4, 0x0F, 0x09);
    P(FM4, 0x10, 0x0A); P(FM4, 0x11, 0x0B); P(FM4, 0x12, 0x0C); P(FM4, 0x13, 0x0B); P(FM4, 0x14, 0x0D); P(FM4, 0x15, 0x0B);
    P(FM4, 0x16, 0x0C); P(FM4, 0x17, 0x0B); P(FM4, 0x18, 0x0B); P(FM4, 0x19, 0x0E); P(FM4, 0x1A, 0x0E); P(FM4, 0x1B, 0x0F);
    P(FM4, 0x1C, 0x0F); P(FM4, 0x1D, 0x10); P(FM4, 0x1E, 0x10); P(FM4, 0x1F, 0x11); P(FM4, 0x20, 0x11);
    ...
    P(FM1, 0x09, 0x04); P(FM1, 0x0A, 0x05); P(FM1, 0x0B, 0x06); P(FM1, 0x0C, 0x05); P(FM1, 0x0D, 0x04); P(FM1, 0x0E, 0x05);
    P(FM1, 0x0F, 0x07); P(FM1, 0x10, 0x08); P(FM1, 0x11, 0x04); P(FM1, 0x12, 0x05); P(FM1, 0x13, 0x06); P(FM1, 0x14, 0x05);
    P(FM1, 0x15, 0x04); P(FM1, 0x16, 0x05); P(FM1, 0x17, 0x07); P(FM1, 0x18, 0x0F); P(FM1, 0x19, 0x09); P(FM1, 0x1A, 0x0A);
    P(FM1, 0x1C, 0x0B); P(FM1, 0x1D, 0x0C); P(FM1, 0x1E, 0x0D); P(FM1, 0x20, 0x0E);
    ...
    P(FM0, 0x02, 0x01); P(FM0, 0x03, 0x01); P(FM0, 0x04, 0x02); P(FM0, 0x05, 0x01); P(FM0, 0x06, 0x01); P(FM0, 0x07, 0x01);
    P(FM0, 0x08, 0x03); P(FM0, 0x09, 0x04); P(FM0, 0x0A, 0x05); P(FM0, 0x0B, 0x04); P(FM0, 0x0C, 0x05); P(FM0, 0x0D, 0x04);
    P(FM0, 0x0E, 0x06); P(FM0, 0x0F, 0x07); P(FM0, 0x10, 0x03); P(FM0, 0x11, 0x04); P(FM0, 0x12, 0x05); P(FM0, 0x13, 0x04);
    P(FM0, 0x14, 0x05); P(FM0, 0x15, 0x04); P(FM0, 0x16, 0x06); P(FM0, 0x17, 0x07); P(FM0, 0x18, 0x01); P(FM0, 0x19, 0x08);
    P(FM0, 0x1A, 0x09); P(FM0, 0x1B, 0x0A); P(FM0, 0x1C, 0x0B); P(FM0, 0x1D, 0x0C); P(FM0, 0x1E, 0x0D); P(FM0, 0x1F, 0x0E);
    P(FM0, 0x20, 0x0F);
}