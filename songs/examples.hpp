...
namespace ssf2_credit_theme{
    ...
    const uint_fast8_t CHANNELS = 9;
    const uint_fast8_t fx_per_chan[CHANNELS] = {2,1,2,1,1,2,1,1,1};
    const float CLOCK = 60.f;
    const float SPEED = 3.f;
    const float BASETIME = 2.f;
    const uint_fast8_t INSTRUMENTS = 12;
    enum instrument_name{KICK, SNARE, STRING, BASS, MAIN2, MAIN, TRIANGLE, WOOD, HITHAT, CRASH, COWBELL, BASSGUITAR};
