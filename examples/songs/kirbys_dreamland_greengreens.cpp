...
KirbysDreamland_GreenGreensTheme::KirbysDreamland_GreenGreensTheme() : Track_Data(
...
#define UI32 uint_fast32_t
    ...
    SETINSTRDAT(TRIMAIN, C0deTracker::TRIANGLE, C0deTracker::ADSR(100.0f, 0.f, 0.0f, 100.f), 1.f, 0, 1, .5f);
    SETINSTRDAT(SQ50, C0deTracker::SQUARE, C0deTracker::ADSR(100.0f, 0.f, 0.0f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(SQ25, C0deTracker::SQUARE, C0deTracker::ADSR(100.0f, 0.f, 0.0f, 100.f), .3f, 0, .25f, 0);
    SETINSTRDAT(SQ125_LONG, C0deTracker::SQUARE, C0deTracker::ADSR(10.0f, 0.f, 0.0f, 100.f), .3f, 0, .125f, 0);
    SETINSTRDAT(SQ125_SHORT, C0deTracker::SQUARE, C0deTracker::ADSR(80.0f, 3.f, 0.0f, 100.f), .3f, 0, .125f, 0);
    SETINSTRDAT(SQ50_0A, C0deTracker::SQUARE, C0deTracker::ADSR(65.0f, 5.f, 0.3f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(SQ50_0B, C0deTracker::SQUARE, C0deTracker::ADSR(65.0f, 3.f, 0.2222f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(SQ50_0C, C0deTracker::SQUARE, C0deTracker::ADSR(65.0f, 5.f, 0.2222f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(SQ50_0D, C0deTracker::SQUARE, C0deTracker::ADSR(65.0f, 6.f, 0.2222f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(SQ50_0E, C0deTracker::SQUARE, C0deTracker::ADSR(1.767f, 4.4f, 0.1111f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(SQ50_0F, C0deTracker::SQUARE, C0deTracker::ADSR(65.f, 2.840909f, 0.f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(SQ50_10, C0deTracker::SQUARE, C0deTracker::ADSR(65.f, 100.f, 0.3f, 100.f), .3f, 0, .5f, 0);
    SETINSTRDAT(DRUM1, C0deTracker::WHITENOISE, C0deTracker::ADSR(100.f, 10.0f, 0.0f, 100.f), .6f, 0, 0.00377f, 0);
    SETINSTRDAT(DRUM2, C0deTracker::WHITENOISE, C0deTracker::ADSR(100.f, 20.0f, 0.0f, 100.f), .5f, 0, 0.00377f, 0);
    SETINSTRDAT(DRUM3, C0deTracker::WHITENOISE, C0deTracker::ADSR(100.f, 20.0f, 0.0f, 100.f), .4f, 0, 0.00377f, 0);
    SETINSTRDAT(DRUM4, C0deTracker::WHITENOISE, C0deTracker::ADSR(100.f, 20.0f, 0.0f, 100.f), .3f, 0, 0.00377f, 0);
    ...
    I(0xE, K(B,4));
    I(0xF, K(C,4));
    P(NOISE3, 5, 2); P(NOISE3, 6, 2); P(NOISE3, 7, 2); P(NOISE3, 8, 2);
    P(NOISE3, 9, 2); P(NOISE3, 10, 2); P(NOISE3, 11, 2); P(NOISE3, 12, 2);
    ...
    I(0x8, K(B,4));
    I(0xA, K(B,4));
    P(NOISE3, 13, 3); P(NOISE3, 14, 2); P(NOISE3, 15, 2); P(NOISE3, 16, 2); P(NOISE3, 17, 2); P(NOISE3, 18, 2);
    P(NOISE3, 19, 2); P(NOISE3, 20, 2); P(NOISE3, 21, 2); P(NOISE3, 22, 2); P(NOISE3, 23, 3);
    ...
    P(PULSE1, 7, 5); P(PULSE1, 8, 4); P(PULSE1, 9, 4); P(PULSE1, 10, 4);
    ...
    I(0xC, K(F_S,3)); I(0xE, K(F_S,3));
    P(PULSE0, 7, 5); P(PULSE0, 8, 4); P(PULSE0, 9, 4); P(PULSE0, 10, 4);
    ...
    I(0x0C, K(F_S, 5), UI32(0x1F000701));
    I(0x0F, K(F_S,5), UI32(0x1F000301));
    P(TRIANGLE2, 8, 7); P(TRIANGLE2, 9, 4); P(TRIANGLE2, 10, 5); P(TRIANGLE2, 11, 6);
    ...
    I(0x0E, K(B,5));
    P(TRIANGLE2, 13, 9); P(TRIANGLE2, 14, 1); P(TRIANGLE2, 15, 1);
    ...
    P(TRIANGLE2, 17, 11); P(TRIANGLE2, 18, 10); P(TRIANGLE2, 19, 11);
    P(TRIANGLE2, 20, 10); P(TRIANGLE2, 21, 11); P(TRIANGLE2, 22, 10);
