//
// Created by Abdulmajid, Olivier NASSER on 04/02/2022.
//

#include "nokia3310_DUSHMAN_REMOVER.hpp"

Nokia3310_DUSHMAN_REMOVER_Menu::Nokia3310_DUSHMAN_REMOVER_Menu() {
    this->setName(NAME);
    this->setSizeDimensions(ROWS, FRAMES, CHANNELS, FX_per_CHAN);
    this->setTimeDimensions(CLOCK, SPEED, BASETIME);
}

void Nokia3310_DUSHMAN_REMOVER_Menu::load_data() {
