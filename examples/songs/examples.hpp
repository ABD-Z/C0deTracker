...
private:
    ...
    constexpr static const uint_fast8_t ROWS = 16;
    constexpr static const uint_fast8_t FRAMES = 10;
    constexpr static const uint_fast8_t CHANNELS = 4;
    ...
    constexpr static const uint_fast8_t INSTRUMENTS = 2;
...
private:
    ...
    constexpr static const uint_fast8_t ROWS = 16;
    constexpr static const uint_fast8_t FRAMES = 8;
    constexpr static const uint_fast8_t CHANNELS = 7;
    constexpr static const uint_fast8_t fx_per_chan[CHANNELS] = {1,1,1,1,1,1,1};
    constexpr static const float CLOCK = 60.f;
    constexpr static const float SPEED = 6.f;
    constexpr static const float BASETIME = 1.f;
    constexpr static const uint_fast8_t INSTRUMENTS = 5;
...
private:
    ...
    constexpr static const uint_fast8_t ROWS = 16;
    constexpr static const uint_fast8_t FRAMES = 24;
    constexpr static const uint_fast8_t CHANNELS = 5;
    constexpr static const uint_fast8_t fx_per_chan[CHANNELS] = {1,1,1,1,1};
    constexpr static const float CLOCK = 60.f;
    constexpr static const float SPEED = 5.f;
    constexpr static const float BASETIME = 1.f;
    constexpr static const uint_fast8_t INSTRUMENTS = 16;
...
private:
    ...
    constexpr static const float SPEED = 9.f;
    constexpr static const float BASETIME = 1.f;
    constexpr static const uint_fast8_t INSTRUMENTS = 4;
...
private:
    ...
    constexpr static const uint_fast8_t FRAMES = 33;
    constexpr static const uint_fast8_t CHANNELS = 10;
    ...
    constexpr static const uint_fast8_t INSTRUMENTS = 8;
...
private:
    ...
    constexpr static const uint_fast8_t ROWS = 64;
    constexpr static const uint_fast8_t FRAMES = 16;
    constexpr static const uint_fast8_t CHANNELS = 9;
    constexpr static const uint_fast8_t FX_per_CHAN[CHANNELS] = {3,1,2,1,1,2,1,2,1};
    constexpr static const float CLOCK = 60.f;
    constexpr static const float SPEED = 2.f;
    constexpr static const float BASETIME = 2.875f;
    constexpr static const uint_fast8_t INSTRUMENTS = 13;
